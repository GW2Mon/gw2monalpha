...
public class ArmorTypeDao {
	...
	public ArrayList<ArmorType> getArmorTypes(){
		...
		DB db = new DB();
		arrayList = (ArrayList<ArmorType>) db.session.createQuery(""+ArmorType.class).list();
		return arrayList;
	}
	 /**
	...
	public ArrayList<ArmorType> getArmorTypes(int type){
		ArrayList<ArmorType> arrayList = null;
		DB db = new DB();
		arrayList = (ArrayList<ArmorType>) db.session.createQuery("from "+ArmorType.class+" where Type="+type).list();
		return arrayList;
	}
