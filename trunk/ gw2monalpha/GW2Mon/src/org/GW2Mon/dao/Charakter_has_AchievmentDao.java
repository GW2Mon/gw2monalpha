...
public class Charakter_has_AchievmentDao {
	...
	public void setCharakter_has_Achievment(
			Charakter_has_achievment Char_has_Achiev) {
		DB db = new DB(GW2Mon.CharCfg, GW2Mon.CharPath);
	...
	public void setCharakter_has_Achievments(
			ArrayList<Charakter_has_achievment> arrayList) {
		DB db = new DB(GW2Mon.CharCfg, GW2Mon.CharPath);
		Transaction trans = db.session.beginTransaction();
		try {
